...
class LipSyncing:
    def generate_video(self, video_name, audio_file, out_file):
        ...
        parser.add_argument('--checkpoint_path', type=str,
                            ...
                            default=os.path.join(os.path.dirname(__file__), ".\\checkpoints\\wav2lip.pth"),
                            )

        parser.add_argument('--face', type=str,
                            help='Filepath of video/image that contains faces to use', default=video_name)
...
if __name__ == '__main__':
    test_sync = LipSyncing('./videotest_2.mp4',
                           'generated_output_02.wav', './results/test.mp4')
    test_sync.generate_video()
